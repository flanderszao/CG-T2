...
class Objeto3D:
    ...
    def __init__(self):
        ...
        self.t = 1.0  # tempo: 1 → 0 (colapso), depois 0 → 1 (retorno)
    ...
    def ProximaPos(self, v):
        for i in range(len(self.vertices)):
            ...
            base = 0.1
            t_factor = self.t if not self.retornando else (1 - self.t)
            ...
            y_collapse = self.center.y - 5  # ponto mais baixo
            y = self.y_original[i] * self.t + y_collapse * (1 - self.t)
